...
export default function Products(props: { product: products & { images: string[] }; comments: CommentItemType[] }) {
  ...
  const isWished = wishlist != null && productId != null ? wishlist.includes(String(productId)) : false;
          ...
          <div style={{ maxWidth: 600 }} className="flex flex-col space-y-6">
            ...
            <div className="flex space-x-3">
              ...
              <Button
                ...
                leftIcon={isWished ? <IconHeart size={20} stroke={1.5} /> : <IconHeartbeat size={20} stroke={1.5} />}
